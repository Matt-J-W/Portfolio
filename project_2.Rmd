...
```{python clustering-test, echo=FALSE, include=TRUE, comment="", results="markup"}
...
_ = plt.plot(range(2, 20), wcss, marker = 'o')
...
```{python kmeans, echo=FALSE, warning=FALSE, message=FALSE}
