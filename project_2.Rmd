...
```{python clustering-test, echo=TRUE, include=TRUE, comment="", results="markup", warnings=FALSE, message=FALSE}
...
```{python kmeans, echo=FALSE, warning=FALSE, message=FALSE, results='show'}
