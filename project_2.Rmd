...
This dataset contains 1,000,000 rows that simulates e-commerce shopping patterns. This data was sourced from Kaggle and uses the following tools: Python, Pandas, Matplotlib, Sickit-learn
...
p2_data_import = pd.read_csv(r"C:\Users\Matthew.Webb12\Desktop\GitHub Repos\Portfolio3\python data\e_commerce_shopper_behaviour_and_lifestyle.csv")
...
```{python clustering-test, echo=FALSE, warning=FALSE, message=FALSE comment="", results="markup"}
...
From the above plot 5 clusters is where the gradient starts to become more shallow so I will use 8 clusters in this analysis. So now I need to run a final KMeans clustering.

```{python clustering-test, echo=FALSE, warning=FALSE, message=FALSE, results='hide'}
...
```{python, conclusions, comments = "", results='markup', include = FALSE}
...
```{python, conclusions continued, comments = "", results='markup', include = FALSE}
