...
for col in columns_to_check:
  count_tables[col] = p1_data_import[col].value_counts().to_frame(name="Count")
...
print(count_tables[columns_to_check[0]])
```
</div>

<div style="flex:1;">
```{python, echo = FALSE, comment="", results="markup"}
print(count_tables[columns_to_check[1]])
```
</div>

<div style="flex:1;">
```{python, echo = FALSE, comment="", results="markup"}
print(count_tables[columns_to_check[2]])
```
</div>
