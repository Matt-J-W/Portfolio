...
Here we have the counts of the variables which has highlighted an anomalous row we will remove in the vehicle type column, aside from that we can see these key columns don't contain any na incidents
...
for col in columns_to_check:
  average_tables[col] = p1_data_import_cleaned.groupby(col)["Fuel_Efficiency_kmpl"].mean().to_frame(name="Average")
```
