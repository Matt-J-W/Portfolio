...
<div style="flex:1;">
```{python, echo = FALSE}
print(count_tables[columns_to_check[0]].to_html())
```
</div>

<div style="flex:1;">
```{python, echo = FALSE}
print(count_tables[columns_to_check[1]].to_html())
```
</div>

<div style="flex:1;">
```{python, echo = FALSE}
print(count_tables[columns_to_check[2]].to_html())
```
</div>
...
<div style="flex:1;">
```{python, echo = FALSE}
print(mean_distance.to_frame().to_html())
```
</div>

<div style="flex:1;">
```{python, echo = FALSE}
print(count_delivery_type.to_frame().to_html())
```
